  ...
  return (
    <Navbar bg="light" className="mb-3" expanded={navExpanded} >
      <Container fluid>
        ...
        <Navbar.Toggle aria-controls={`offcanvasNavbar-expand`} onClick={() => setNavExpanded(navExpanded ? false : "expanded")} >Login</Navbar.Toggle>
        <Navbar.Offcanvas
        ...
        >
          ...
          <Offcanvas.Body>
            <div className="reset__password__sec">
              ...
              <FormSection showRightPanel={false} />
              </div>
            </div>
