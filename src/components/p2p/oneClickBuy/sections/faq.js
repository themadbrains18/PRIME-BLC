        ...
        <div className='faq-container'>
            ...
            <div className='faq-container-content'>
                <div className='faq-content'>
                    ...
                    <div className='faq-content-item'>How to Buy Coins with Your Credit/Debit Card on BLC Exchange</div>
                    <div className='faq-content-item'>How to Link or Remove Your Credit/Debit Card on BLC Exchange</div>
                    <div className='faq-content-item'>Troubleshooting: Failed to Link Your Credit/Debit Card</div>
                    <div className='faq-content-item'>Troubleshooting: Failed Payments</div>
                    <div className='faq-content-item'>FAQ — Credit/Debit Payments</div>
                    </div>
            </div>
            <button className='faq-btn'>
          <span className='faq-btn_ext'>Check</span>
          <span className='faq-btn_icon'>
