...
const MainAccount = ({ showSideBar }) => {
  ...
  assets = assets.filter((item) => {
    return item.accountType === 'Main Account';
  })
  ...
  return (
    <div className="overview__container main__account__container">
      ...
      <div className="account__wallet__list">
        ...
        <div className="account__wallet__list__info">
          <div className="account__wallet__list__info__header">
            ...
            <span className="column4">Action</span>
          </div>
          {assets?.map((val, index) => {
            ...
            return <div key={val.token} className="account__wallet__list__info__row">
              ...
              <span className="column1">{(parseFloat(val?.balance))}</span>
      ...
      <TransferComponent selectedToken={selectedToken} open={open} closeModel={closeModel} accountType="Main Account" wallet="main_wallet" />
    </div>
  )
}
